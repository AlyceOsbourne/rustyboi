...
export class WebApp {
    ...
    set_button(button, pressed) {
        ...
        wasm.webapp_set_button(this.__wbg_ptr, button, pressed);
    }
    /**
    ...
    constructor(canvas_id) {
        ...
        const ret = wasm.webapp_new(ptr0, len0);
        if (ret[2]) {
    ...
    draw() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        wasm.webapp_draw(this.__wbg_ptr);
    }
    /**
    ...
    load_rom(rom_data) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webapp_load_rom(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
    ...
    is_loaded() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ret = wasm.webapp_is_loaded(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    run_frame() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        wasm.webapp_run_frame(this.__wbg_ptr);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_set_imageSmoothingEnabled_13d5d7d0020d0c49 = function() { return logError(function (arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rustyboi_visualizer_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
